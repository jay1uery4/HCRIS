...
const loggedInUser = "john_doe"; // Replace this with actual logic to fetch logged-in username
...
getAppointmentBtn.addEventListener("click", (e) => {
    ...
    if (loggedInUser) {
        appointmentUsername.value = loggedInUser;
    } else {
        appointmentUsername.value = ""; // Leave empty if not logged in
    }
});
